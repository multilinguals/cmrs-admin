  ...
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="用户角色" width="110px" align="center">
        <template slot-scope="scope">
          <span><el-button type="text">查看</el-button></span>
        </template>
      </el-table-column>
      ...
      <el-table-column label="创建时间" sortable width="500px" align="center">
        <template slot-scope="scope">
          <span>{{ scope.row.createdAt }}</span>
        </template>
      </el-table-column>
      <el-table-column label="Actions" fixed="right" align="center" width="330" class-name="small-padding fixed-width">
